 ...
 * limitations under the License.
 * =============================================================================
 */var Cs;(function(t){t.R0="R0",t.R1="R1",t.R2="R2",t.R3="R3",t.R4="R4",t.R5="R5",t.R6="R6"})(Cs||(Cs={}));var Ls;(function(t){t.float32="float32",t.int32="int32",t.bool="int32",t.complex64="complex64"})(Ls||(Ls={}));var Bs;(function(t){t.float32="float32",t.int32="int32",t.bool="bool",t.complex64="complex64"})(Bs||(Bs={}));var Ps;(function(t){t.float32="float32",t.int32="float32",t.bool="float32",t.complex64="complex64"})(Ps||(Ps={}));var zs;(function(t){t.float32="complex64",t.int32="complex64",t.bool="complex64",t.complex64="complex64"})(zs||(zs={}));const qf={float32:Ps,int32:Ls,bool:Bs,complex64:zs};function rs(t,e){if(t==="string"||e==="string"){if(t==="string"&&e==="string")return"string";throw new Error(`Can not upcast ${t} with ${e}`)}return qf[t][e]}function Gf(t){return rs(t,"int32")}function lc(t){return t!=null&&typeof t=="object"&&"texture"in t&&t.texture instanceof WebGLTexture}function hc(t){return typeof GPUBuffer<"u"&&t!=null&&typeof t=="object"&&"buffer"in t&&t.buffer instanceof GPUBuffer}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jg(t,e){let n=d(t,"a","greaterEqual","string_or_numeric"),s=d(e,"b","greaterEqual","string_or_numeric");[n,s]=ee(n,s),re(n.shape,s.shape);const r={a:n,b:s};return N.runKernel(bi,r)}const Rr=w({greaterEqual_:jg});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function wy(t,e){let n=d(t,"a","maximum"),s=d(e,"b","maximum");[n,s]=ee(n,s),n.dtype==="bool"&&(n=J(n,"int32"),s=J(s,"int32")),re(n.shape,s.shape);const r={a:n,b:s};return N.runKernel(Ci,r)}const Mr=w({maximum_:wy});/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Rt(t,e,n){if(It(t),e!=null&&e.length!==2)throw new Error("tensor2d() requires shape to have two numbers");const s=Be(t,n);if(s.length!==2&&s.length!==1)throw new Error("tensor2d() requires values to be number[][] or flat/TypedArray");if(s.length===1&&e==null)throw new Error("tensor2d() requires shape to be provided when `values` are a flat/TypedArray");return ct(t,e,s,n)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ms(t,e,n){if(n==null||n==="linear")return t;if(n==="relu")return D(t,ta(e));throw new Error(`Cannot compute gradient for fused activation ${n}.`)}function gs(t,e){let n=e;const s=_r(t.shape,e.shape);return s.length>0&&(n=X(n,s)),I(n,t.shape)}function ys(t,e,n,s){if(e==="linear")return t;if(e==="relu")return vn(t);if(e==="elu")return xr(t);if(e==="relu6")return Jr(t);if(e==="prelu")return qr(t,n);if(e==="leakyrelu")return Cr(t,s);if(e==="sigmoid")return wt(t);throw new Error(`Unknown fused activation ${e}.`)}const bs=(t,e)=>!(t>0)||e==="linear";/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function z0(t,e,n,s=!1,r=0){let a=0;const o=[];for(;a+e<=t.size;)o.push(H(t,a,e)),a+=n;if(s)for(;a<t.size;){const i=a+e-t.size,u=he([H(t,a,e-i),jt([i],r)]);o.push(u),a+=n}return o.length===0?Rt([],[0,e]):I(he(o),[o.length,e])}const Hh=w({frame_:z0});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
Manifest JSON has weights with names: ${i.join(", ")}.`)}const u=r.reduce((m,b,T)=>(b&&m.push(T),m),[]),c=[];u.forEach(m=>{e[m].paths.forEach(b=>{const T=n+(n.endsWith("/")?"":"/")+b;c.push(T)})});const h=await t(c),l={};let f=0;return u.forEach(m=>{const b=e[m].paths.length,T=new Ce(h.slice(f,f+b));a[m].forEach($=>{const O=T.slice($.groupOffset,$.groupOffset+$.sizeBytes),v=wc(O,[$.manifestEntry]);for(const _ in v)l[_]=v[_]}),f+=b}),l}}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function R1(t,e,n){const s=d(t,"labels","confusionMatrix"),r=d(e,"predictions","confusionMatrix");g(n==null||n>0&&Number.isInteger(n),()=>`If provided, numClasses must be a positive integer, but got ${n}`),g(s.rank===1,()=>`Expected the rank of labels to be 1, but got ${s.rank}`),g(r.rank===1,()=>`Expected the rank of predictions to be 1, but got ${r.rank}`),g(s.shape[0]===r.shape[0],()=>`Mismatch in the number of examples: ${s.shape[0]} vs. ${r.shape[0]}. Labels and predictions should have the same number of elements.`),g(n>0&&Number.isInteger(n),()=>`numClasses is required to be a positive integer, but got ${n}`);const a=Yn(J(s,"int32"),n),o=Yn(J(r,"int32"),n),i=fn(a),u=j(i,o);return J(u,"int32")}const C1=w({confusionMatrix_:R1});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
